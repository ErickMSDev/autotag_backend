...
namespace AutoTagBackEnd.Services
{
	public class PbiEmbedService
	{
        ...
        public EmbedParams GetEmbedParams(Guid workspaceId, Guid reportId, string email, string rolCode, [Optional] Guid additionalDatasetId)
        {
            ...
            else
            {
                ...
                embedToken = GetEmbedToken(reportId, datasetIds, workspaceId, email, rolCode);
            }
        ...
        /// <remarks>This function is not supported for RDL Report</remakrs>
        public EmbedToken GetEmbedToken(Guid reportId, IList<Guid> datasetIds, [Optional] Guid targetWorkspaceId, string email, string rolCode)
        {
            PowerBIClient pbiClient = this.GetPowerBIClient();
            ...
            //var tokenRequest = new GenerateTokenRequest(accessLevel: "View", datasetId: datasetId.ToString());

            //// Generate Embed token
            //EmbedToken? embedToken = null;
            //try
            //{
            //    embedToken = pbiClient.Reports.GenerateTokenInGroup(targetWorkspaceId, reportId, tokenRequest);
            //}
